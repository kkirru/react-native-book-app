...
export default class HomeScreen extends React.Component {
    constructor(props) {
        // constructor 안에서 props 접근하려면 super에 props 전달해야함 
        super(props)
        this.state = {
            totalCount: 0,
            readingCount: 0,
    ...
    // server request 보내기 좋은 곳
    componentDidMount() {
        console.log('mount')
    }

    // state 변경 될 때마다 called
    // prevProps,prevState parameter로 가질 수 있음
